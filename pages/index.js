...
<br/>
			...
			<!-- Service Start -->  */}
				...
				<section class="text-center pt-60 pb-60">
					<div class="container">
						<div class="row">
						<div class="col-lg-12">
						...
						<div class="col">
							...
							<div class="step-desc">
								<h4>Submit Medical Imaging</h4>
								<p class="mb-0">Upload CT or MRI scans through our secure portal or coordinate directly with our clinical team.</p>
							</div>
							</div>
						</div>
						<div class="col">
							...
							<div class="step-desc">
								...
								<p class="mb-0">Our engineers create 3D anatomical reconstructions and design patient-specific solutions in consultation with your surgical team.</p>
							</div>
							</div>
						</div>
						<div class="col">
						...
						<div class="col">
							...
							<div class="step-desc">
								...
								<p class="mb-0">Every product undergoes dimensional inspection, biocompatibility validation, and sterilization before delivery.</p>
							</div>
							</div>
						</div>
						<div class="col">
							...
							<div class="step-desc">
								...
								<p class="mb-0">Receive your custom solution with comprehensive documentation and clinical support for surgical implementation.</p>
							</div>
							</div>
						</div>
						</div>
