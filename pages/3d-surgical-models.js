...
export default function Home() {
	...
	return (
		<>
			<Head>
				<title>Custom 3D Printed Anatomical Models | Curewith3D</title>
				<meta name="description" content="CT/MRI based anatomical bone models, dental models, tumor models, to facilitate pre-surgery planning for complex orthopedic, facial trauma, OMF & cranial cases"/>
